...
Item {
    ...
    property bool isActive: Hyprland.focusedMonitor !== null &&
                             ...
                             Hyprland.focusedMonitor.activeWorkspace.id === workspace.id
    ...
    Rectangle {
        ...
        Text {
            ...
            transform: Translate { x: sunken ? 1 : 0; y: sunken ? 1 : 0 }

            text:            root.workspace.id !== undefined ? root.workspace.id : "?"
